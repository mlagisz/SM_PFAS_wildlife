...
# Group by Study_ID and count unique species
species_count <- Species %>%
  group_by(Study_ID) %>%
  summarise(num_species = n_distinct(Scientific_name))

# Calculate average and median
average_species <- mean(species_count$num_species)
median_species <- median(species_count$num_species)

# Print the results
cat("Average number of species:", average_species, "\n")
#Average number of species: 4.055077 

cat("Median number of species:", median_species, "\n")
#Median number of species: 2 
...
sankeyNetwork_plot <- sankeyNetwork(Links = sankey_author, Nodes = nodes,
                   Source = "IDsource", Target = "IDtarget", Value = "n", NodeID = "name", fontSize = 15,
                   sinksRight=FALSE)
...
webshot("sankeyNetwork_plot.html", file = "sankeyNetwork_plot.png", vwidth = 1000, vheight = 900)
