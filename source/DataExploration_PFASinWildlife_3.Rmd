...
Habitat_Species_bubble <- ggplot(Habitat_Species_count, aes(x= reorder(Habitat, -n), y = reorder(Species_higher_taxon, -n), size = n)) +
    geom_point(alpha=0.7) + theme_minimal() +
  labs(y="Classes", x = "Habitat") + 
  theme(axis.text.x = element_text(angle = 90, vjust = 0.5, hjust=1))

#ggsave("Habitat_Species_bubble.jpg", plot = Habitat_Species_bubble, device = 'jpg', width = 150, height = 100, units = "mm", dpi = 300, limitsize = TRUE)
...
#ggsave("Region_Species_bubble.jpg", plot = Region_Species_bubble, device = 'jpg', width = 150, height = 100, units = "mm", dpi = 300, limitsize = TRUE)
