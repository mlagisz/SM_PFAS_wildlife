...
PFAS_Compounds_long <- 
 ggplot(data = PFAS_Compounds_21, aes(x = reorder(PFAS_name, -n), y = n, fill = Chain_length)) + 
  geom_bar(stat = "identity") + 
  theme(axis.text.x = element_text(angle = 45, vjust = 0.5, hjust = 1)) + 
  labs(y = "Count", x = "PFAS compounds", fill = 'Carbon chain length') + 
  theme_minimal() + coord_flip() + 
...
#ggsave("PFAS_Compounds_long.jpg", plot = PFAS_Compounds_long, device = 'jpg', width = 168, height = 100, units = "mm", dpi = 300, limitsize = T)
