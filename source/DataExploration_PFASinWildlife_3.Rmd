...
ggplot(Sampling_Period_Class_no_NA_SHORT_2, aes(x=Species_higher_taxon, y=SamplingPeriod, fill=Species_higher_taxon)) + 
  ...
  scale_fill_manual(values = c("Actinopterygii"="blue", "Aves"="red", "Mammalia"="green", "Malacostraca"="orange", "Bivalvia"="purple", "Gastropoda"="yellow", "Reptilia"="black", "Insecta"="brown", "Cephalopoda"="pink", "Chondrichthyes"="gray")) +
  guides(fill = FALSE)
